...
# <img src="Logo/bandcamp-button-circle-line-aqua-128.png" width="32" height="32" alt="Icon"> Bandcamp Player

[![Download](https://img.shields.io/badge/Download-Latest-blue)](https://github.com/kameryn1811/Bandcamp-Player/releases/tag/Launcher_v1.0.0)

</div>

A standalone mini player for Bandcamp that provides a compact, always-on-top interface for streaming music directly from Bandcamp.

## What It Does

Bandcamp Player is a lightweight desktop application that lets you stream music from Bandcamp in a minimal, unobtrusive window. It features playlist management, keyboard shortcuts, media key support, and multiple viewing modes.

*The main player interface with playlist sidebar, compact mode, and always-on-top support.*
...
* **Multiple View Modes** - Regular, Mini, Micro, and Nano modes for different use cases.
* **Playlist Management** - Create and manage playlists of your favorite Bandcamp albums and tracks.
...
* **Media Key Support** - Use your keyboard's media keys to control playback (Windows).
* **System Tray** - Minimize to system tray for background operation.
* **Detachable Playlist** - Detach the playlist window for flexible window management.
* **Nano Player** - Ultra-compact floating player that appears when minimized.
* **Autoplay** - Automatically play next track in playlist.
...
**For users who prefer manual setup:**
  - Smaller download (~script vs ~launcher)
...
1. Download the [Latest Release](https://github.com/kameryn1811/Bandcamp-Player/releases/latest) and extract it into a folder e.g. /Bandcamp Player
2. Double-click `run_player.bat` (optionally create a shortcut to this file and pin it to your start menu, taskbar, desktop, etc)
3. The app will check for and help install any missing dependencies
4. Profit

## Usage

1. **Add URLs to Playlist**: Drag and drop Bandcamp URLs into the playlist, or use the add button.
